...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <header class="main-header">
                        ...
                        <div class="top-right pull-right">
                            <ul class="info clearfix">
                                ...
                                <li class="p_relative d_iblock float_left lh_55 pl_25 fs_16">
                                    <i class="icon-3"></i>
                                    <p>Email: <a href="mailto:sample@example.com">info@albaprotien.com</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="header-lower">
                <div class="auto-container">
                    <div class="outer-box">
                        ...
                        <div class="btn-box">
                            <a href="/login" class="theme-btn theme-btn-one">Login / Register<i class="icon-4"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="sticky-header">
                <div class="auto-container">
                    <div class="outer-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="#"><img src="assets/images/logo.png" style="height: 50px;" alt=""></a></figure>
                        </div>
                        <div class="menu-area clearfix">
                        ...
                        <div class="btn-box">
                            <a href="login.html" class="theme-btn theme-btn-one">Login / Register<i class="icon-4"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="#"><img src="assets/images/mobile-logo.png" style="height: 70px;" alt="" title=""></a></div>
                ...
                <div class="contact-info">
                    ...
                    <ul>
                        ...
                        <li><a href="mailto:info@example.com">info@albaprotien.com</a></li>
                    </ul>
                </div>
        ...
        <section class="slider-one centred p_relative">
            <div class="banner-carousel owl-theme owl-carousel owl-dots-none">
                <div class="slide-item p_relative pt_140 pb_170">
                    ...
                    <div class="auto-container">
                        <div class="content-box p_relative d_block z_5">
                            <h2 class="p_relative d_iblock fw_bold fs_80 lh_70 mb_25"><span class="slider-text-anim">We Know The</span><br /> <span class="slider-text-anim">Right Way Of Trading.</span></h2>
                            <p class="d_block fs_18 mb_45">Start trading with AlbaProtien and earn regular profits.</p>
                            <div class="btn-box clearfix">
                                <a href="#" class="theme-btn theme-btn-two"><span data-text="Get Started">Get Started</span></a>
                            </div>
                        </div> 
                    </div>
                </div>
                <div class="slide-item p_relative pt_140 pb_170">
                    ...
                    <div class="auto-container">
                        <div class="content-box p_relative d_block z_5">
                            <h2 class="p_relative d_iblock fw_bold fs_80 lh_70 mb_25"><span class="slider-text-anim"> Trading Will Make You</span><br /> <span class="slider-text-anim">Feel Better.</span></h2>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image_block_one">
                                <div class="image-box p_relative d_block mr_30 pb_100 pt_130">
                                    ...
                                    <figure class="image image-1 p_relative d_block b_radius_10"><img src="assets/pic-1.jpg" alt=""></figure>
                            ...
                            <div class="content_block_one">
                                <div class="content-box p_relative d_block ml_30">
                                    ...
                                    <div class="text p_relative d_block mb_25 wow fadeInUp" data-wow-duration="1500ms">
                                        <p>Here at AlbaProtien, We provide 2 packages in which you can invest and earn profit on daily basis and withdraw your amount after each 15 days and the investment will be kept for 180 days.</p>
                                    </div>
                                    <ul class="list-style-one clearfix p_relative d_block mb_30 wow fadeInUp" data-wow-duration="1500ms">
                                        <li class="p_relative d_block fs_16 lh_25 fw_sbold pull-left pl_35 mb_13">Per KG Profits</li>
                                        <li class="p_relative d_block fs_16 lh_25 fw_sbold pull-left pl_35 mb_13">Daily Profits</li>
                                        <li class="p_relative d_block fs_16 lh_25 fw_sbold pull-left pl_35 mb_13">Reference Earnings</li>
                                        <li class="p_relative d_block fs_16 lh_25 fw_sbold pull-left pl_35 mb_13">5% Monthly Profit</li>
                                        <li class="p_relative d_block fs_16 lh_25 fw_sbold pull-left pl_35">15 Days Withdraw</li>
                                    </ul>
                                    <div class="btn-box wow fadeInUp" data-wow-duration="1500ms">
                                        <a href="#" class="theme-btn theme-btn-three"><span data-text="Invest Now">Invest Now</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one wow slideInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                                ...
                                <h4 class="p_relative d_block fs_20 lh_30 fw_sbold mb_20"><a href="#">Create Account</a></h4>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one wow slideInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                                ...
                                <h4 class="p_relative d_block fs_20 lh_30 fw_sbold mb_20"><a href="#">Find Nearest Office</a></h4>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one wow slideInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                                ...
                                <h4 class="p_relative d_block fs_20 lh_30 fw_sbold mb_20"><a href="#">Select Package</a></h4>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-one wow slideInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                                ...
                                <h4 class="p_relative d_block fs_20 lh_30 fw_sbold mb_20"><a href="#">Enjoy Your Profit</a></h4>
        ...
        <section class="video-one p_relative pt_140 pb_150">
            <div class="bg-layer p_absolute l_0 parallax_none parallax-bg" data-parallax='{"y": 100}' style="background-image: url(assets/images/banner/banner-2.jpg);"></div>
            <div class="pattern-layer">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                            <div class="content_block_two">
                                <div class="content-box p_relative d_block mr_130 z_1">
                                    <div class="sec-title p_relative d_block mb_20">
                                        <span class="sub-title p_relative d_iblock fs_15 fw_medium g_color mb_19">Why Choose AlbaProtien</span>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image_block_two">
                                <div class="image-box p_relative d_block ml_30 pb_140 mt_20" style="margin-top: 150px;">
                                    ...
                                    <figure class="image image-2 p_absolute l_0 b_0 b_radius_10 d_block"><img src="assets/pic-4.jpg" alt=""></figure>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 processing-block">
                        <div class="processing-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block">
                                ...
                                <p>Beef is the prime traded product as the country ranked among the top 20 meat exporters in the world.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 processing-block">
            ...
            <div class="auto-container">
                <div class="inner-container p_relative sec-pad">
                    ...
                    <div class="sec-title p_relative d_block mb_35 text-center z_1">
                        <span class="sub-title p_relative d_iblock fs_15 fw_medium g_color mb_19">Our Packages</span>
                        <h2 class="p_relative d_block fs_40 fw_bold mb_30">Choose a Package to <br>Get Started</h2>
                    </div>
                    <div class="tabs-box">
                                        ...
                                        <div class="pricing-block-one">
                                            <div class="pricing-table p_relative d_block pt_45 pr_50 pb_50 pl_50 b_radius_10">
                                                <div class="table-header p_relative d_block mb_30">
                                                    ...
                                                    <h2 class="d_block fs_40 lh_50 fw_bold mb_0">250 KGs <span class="fs_17">/ 180 Days</span></h2>
                                                    <p class="fs_18">Invest in 250 KGs with PKR 1200 per KG</p>
                                                </div>
                                                <div class="table-content p_relative d_block p_relative pt_25 pr_30 pl_30 pb_25 b_radius_10 mb_40">
                                                    <ul class="feature-list clearfix">
                                                        <li class="p_relative d_block fs_16 lh_25 pl_25 mb_16">Rs. 5 per KG Profit</li>
                                                        <li class="p_relative d_block fs_16 lh_25 pl_25 mb_16">5 Days a week profit return</li>
                                                        <li class="p_relative d_block fs_16 lh_25 pl_25">15 Days Withdraw</li>
                                                    </ul>
                                                </div>
                                                <div class="table-footer">
                                                    <a href="#" class="theme-btn theme-btn-two"><span data-text="Select Plan">Select Plan</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="pricing-block-one active-block">
                                            <div class="pricing-table p_relative d_block pt_45 pr_50 pb_50 pl_50 b_radius_10">
                                                ...
                                                <div class="table-header p_relative d_block mb_30">
                                                    ...
                                                    <h2 class="d_block fs_40 lh_50 fw_bold mb_0">450 KGs <span class="fs_17">/ 180 Days</span></h2>
                                                    <p class="fs_18">Invest in 450 KGs with PKR 1200 per KG</p>
                                                </div>
                                                <div class="table-content p_relative d_block p_relative pt_25 pr_30 pl_30 pb_25 b_radius_10 mb_40">
                                                    <ul class="feature-list clearfix">
                                                        <li class="p_relative d_block fs_16 lh_25 pl_25 mb_16">Rs. 6 per KG Profit</li>
                                                        <li class="p_relative d_block fs_16 lh_25 pl_25 mb_16">5 Days a week profit return</li>
                                                        <li class="p_relative d_block fs_16 lh_25 pl_25">15 Days Withdraw</li>
                                                    </ul>
                                                </div>
                                                <div class="table-footer">
                                                    <a href="#" class="theme-btn theme-btn-one">Select Plan<i class="icon-4"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="auto-container">
                    <div class="top-inner clearfix">
                        <figure class="footer-logo pull-left">
                            <a href="#"><img src="assets/images/footer-logo.png" style="height: 70px;" alt=""></a>
                        </figure>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-4 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget about-widget wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                ...
                                <div class="text">
                                    <p>AlbaProtien is a trading platform for meat where you can invest and earn profit.</p>
                                </div>
                            ...
                            <div class="footer-widget contact-widget wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                ...
                                <div class="widget-content">
                                    <ul class="info-list clearfix">
                                        ...
                                        <li><a href="mailto:sample@example.com">info@albaprotien.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="auto-container">
                    <div class="bottom-inner clearfix">
                        <div class="copyright pull-left">
                            <p><a href="#">AlbaProtien</a> &copy; 2023 All Right Reserved</p>
                        </div>
